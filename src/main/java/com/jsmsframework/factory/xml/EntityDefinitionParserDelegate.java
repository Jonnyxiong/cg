package com.jsmsframework.factory.xml;
 ...
 ;
 import com.jsmsframework.exception.GroupDefinitionException;
 import com.jsmsframework.factory.config.ArtifactDefinition;
 import com.jsmsframework.factory.config.EntityDefinition;
 import com.jsmsframework.factory.config.EntityDefinitionHolder;
 import com.jsmsframework.factory.config.GroupDefinition;
...
public class EntityDefinitionParserDelegate {
    public static final String CODEGEN_NAMESPACE_URI = "http://www.jsms.com/schema/cg";
    ...
    private static final String DEFAULT_PAGE_BEAN_CLASS = "com.jsmsframework.dto.Page";
