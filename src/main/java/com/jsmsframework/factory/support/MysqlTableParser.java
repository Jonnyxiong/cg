...
import com.jsmsframework.factory.utils.CamelCaseUtils;
    ...
    public List<FileHolder> parse() {
        ...
        try {
            ...
            for (Map.Entry<String, EntityDefinition> entry : codegenContext.getEntityDefinitionMap().entrySet()) {
                ...
                String fileNamePrefix = groupDefinition.getFileNamePrefix();
                String defaultPageClass = groupDefinition.getDefaultPageClass();
